...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const orgsUrl = 'https://api.linkedin.com/v2/organizationAcls?q=roleAssignee&role=ADMINISTRATOR'
    ...
    redirect(`/dashboard/settings/social-accounts?error=${encodeURIComponent(error instanceof Error ? error.message : 'Failed to connect LinkedIn')}`)
  }
}
